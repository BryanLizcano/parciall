class ApiConfig {
  ...
  static String entrepreneurProfile(int id) =>
      '$baseUrl/users/entrepreneur/$id';
  ...
  static String chatHistory(int partnerId) =>
      '$baseUrl/chat/messages/$partnerId';

  /// HU-17: Marcar mensajes de una conversación como leídos
  static String readChatMessages(int partnerId) =>
      '$baseUrl/chat/messages/read/$partnerId';
  ...
  static String entrepreneurReviews(int id) =>
      '$baseUrl/reviews/entrepreneur/$id';

  /// HU-19 CA-2: Obtener resumen/distribución de calificaciones de un emprendedor
  static String entrepreneurReviewsSummary(int id) =>
      '$baseUrl/reviews/entrepreneur/$id/summary';
